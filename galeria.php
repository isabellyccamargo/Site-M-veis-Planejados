      ...
      <footer class="bg- pt-5 pb-4">
        <div class="container text-md-left">
          <div class="row text-md-left">
            ...
            <!-- Logo e descrição -->
            <div class="logodescriçao col-md-3 col-lg-3 col-xl-3 mx-auto mt-3 ">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
              ...
              <p class="outros"><i class="">Endereço: Vila Rural Andorinha, Rua Aparecida Bernardo Valarini (Casa de
                  esquina), Araruna - BR</i></p>
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mt-3">
              ...
              <p>
                <a href="https://www.instagram.com/ribeiroambientesplanejados" target="_blank" class="insta me-3">
              ...
              <p>
                <a href="https://www.instagram.com/jefferson_ribeero?igsh=cHhkYjV0bTl1dm9r" target="_blank"
                  class="insta icon  me-3"> <i class="fab fa-instagram fa-lg"></i>
                  @jefferson_ribeero
                </a>
              </p>
              <p>
